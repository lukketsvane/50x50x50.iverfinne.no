 ...
 *
 * Sandkassen hadde ein handskriven GLB-lesar som las eitt format. Slicerman
 * les fem, har gjort det lenge, og er prøvd på filer frå skannarar, Blender
 * og CAD. Å halde to lesarar i live er å halde to sett feil i live.
 */
/**
 * OBJ inn.
 *
