/**
 * LÅNT FRÅ SLICERMAN — lukketsvane/slicer.iverfinne.no, MIT, same forfattar.
 *
 * GJEST snitta før dette rett gjennom trekantsuppa: kvar trekant som kryssa
 * planet gav eit linestykke, og linestykka vart kjeda til konturar. Det er
 * ei rekning som ALDRI får vita om eit punkt er inne i objektet eller ute —
 * ho kjenner berre kanten. Difor kunne ho ikkje skjere eit spor, ho kunne
 * ikkje skilje eit hòl frå eit stykke, og ho måtte gjette på kva ring som
 * var ytterkonturen.
 *
 * Strålen svarar på nett det spørsmålet, og resten fylgjer av seg sjølv.
 */
/**
