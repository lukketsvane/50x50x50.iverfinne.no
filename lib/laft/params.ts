...
export const POSES: readonly Partial<Params>[] = [
  ...
  // settet — full høgd berre knapt halvvegs ut, og ei tydeleg midje
  // over foten — so frå sida er understellet fire bein under ein port.
  // Krysset står på tvers: det einaste fotavtrykket som er breiare enn
  // djupt.
  {
  ...
  // full høgd nesten heilt ut til foten og INGA midje, so sidesilhuetten
  // er ei FLATE med ein port i og ikkje eit bein. Djupaste og smalaste
  // fotavtrykket: ovanfrå eit langt, smalt skip. Ingen berehol — han vert
  // ikkje flytta.
  {
  ...
  // eit brett. Bladet har den djupaste midja i settet: ein ankel over
  // foten, so beina spriker som på eit insekt. Den eine posen der ein
  // ikkje sit oppreist, men fell attover og vert verande.
  {
