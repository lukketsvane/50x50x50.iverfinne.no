 ...
 * monaleg, av di ringane er annulusar og hòlet i midten er reint avfall —
 * men det er ei pakking ein kan tru på, og det er talet som avgjer kor
 * mange plater ein må kjøpa.
 *
 * Delane vert sorterte etter areal og ikkje etter høgd. Med hyller vert
 * radhøgda sett av den høgste delen i rada, og eitt blad på 426 mm gjer då
 * heile rada 426 mm høg; med frie rektangel kan to blad stå oppå kvarandre
 * i den luka setet og ringane let stå att.
 */
