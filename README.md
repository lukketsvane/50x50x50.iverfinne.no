...
ledd. Og han er den einaste som har TO former: stolen, og bunten han kjem
som. Kortet i panelet syner pakken — delane stabla flate mot kvarandre,
med den største som omslag og eit av møbelet sine eigne hòl som hank — av
di det er det ein vil sjå av eit flatpakka møbel. Pakken vert målt mot den
SAME kuben som stolen, og det er den einaste regelen i heile sandkassen
som ser på lengda av ein ENKELT del. Prisen og vinsten står i tavla hans,
side om side. Reiskapen er bygd for å lage ÉIN krakk som passar
